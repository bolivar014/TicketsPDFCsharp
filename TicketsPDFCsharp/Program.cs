...
class Program
{
    ...
    public static void GenerarFacturasPost()
    {
        // Crear una instancia de la clase Random
        Random random = new Random();
        ...
        // Crear un nuevo documento PDF con tamaño reducido
        Document document = new Document(new Rectangle(216, 720)); // Tamaño del ticket POS (3x10 pulgadas)
        document.SetMargins(10, 10, 10, 10); // Márgenes reducidos
        ...
        // Información del ticket
        Font contentFont = FontFactory.GetFont("Arial", 10, Font.NORMAL);
        document.Add(new Paragraph("Fecha: " + DateTime.Now.ToString("dd/MM/yyyy"), contentFont));
        document.Add(new Paragraph("Hora: " + DateTime.Now.ToString("HH:mm:ss"), contentFont));
        document.Add(new Paragraph("Número de Ticket: 12345", contentFont));
        document.Add(new Paragraph("Nombre del Cliente: Pepito Pérez", contentFont));
        ...
        PdfPCell cell = new PdfPCell(new Phrase("Producto", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("Cantidad", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("Precio", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("Producto A", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);
        ...
        cell = new PdfPCell(new Phrase("$20.00", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("Producto B", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("1", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);

        cell = new PdfPCell(new Phrase("$15.00", contentFont));
        cell.Border = Rectangle.NO_BORDER;
        table.AddCell(cell);
